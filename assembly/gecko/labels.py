...
GE_LABEL_PDF = 'gecko_label.pdf'
GE_LABEL_SVG = 'gecko_label.svg'
...
label_specs['gecko'] = {}
label_specs['gecko']['offset_x'] = 25
label_specs['gecko']['gap_x']    = 0
label_specs['gecko']['width_x']  = 72
label_specs['gecko']['offset_y'] = 30
label_specs['gecko']['gap_y']    = 0
label_specs['gecko']['height_y'] = 36
label_specs['gecko']['y_count']  = 20
label_specs['gecko']['x_count']  = 8
...
if sys.argv[2] == 'cc':
	...
	label_rotate = True
	label_txt_func = None
elif sys.argv[2] == 'gecko':
	ltype = 'gecko'
	label_pdf = GE_LABEL_PDF
	label_svg = GE_LABEL_SVG
	label_pixels_x = 36
	label_pixels_y = 72
	label_qr_pos_x = 4
	label_qr_pos_y = 18.5
